...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        default:
          "bg-white text-black border-rose-200 border-2 border-b-4 active:border-b-2 hover:bg-rose-50 text-rose-500",
        ...
        primaryOutline: "bg-white text-rose-500 hover:bg-rose-50",

        secondary:
          "bg-rose-400 text-primary-foreground hover:bg-rose-400/90 border-rose-500 border-b-4 active:border-b-0",
        secondaryOutline: "bg-white text-rose-400 hover:bg-rose-50",
        ...
        sidebarOutline:
          "bg-rose-500/15 text-rose-500 border-rose-300 border-2 hover:bg-rose-500/20 transition-none",
      },
      size: {
